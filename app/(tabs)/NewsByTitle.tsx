...
import {getNewsByTitle} from "@/app/api/api";
import SearchBar from "@/app/components/SearchBar";

const NewsByTitle = () => {
    const {data, error, loading, refetch} = useFetch<News>(getNewsByTitle, false, "");
    ...
    return (
        <View className="px-5 flex-1 mt-20">
            <Text className="font-bold text-xl">NewsByTitle</Text>
            <Text className="mt-2">This screen is responsible for fetching articles by title</Text>
